...
// Generated 2016-8-4 17:57:58 by Hibernate Tools 3.4.0.CR1
 ...
 * @see com.base.hibernate.beans.Login
	...
	public Login findById(java.lang.Integer id) {
		...
		try {
			Login instance = (Login) sessionFactory.getCurrentSession().get(
					"com.base.hibernate.beans.Login", id);
			if (instance == null) {
	...
	public List findByExample(Login instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession()
					.createCriteria("com.base.hibernate.beans.Login")
